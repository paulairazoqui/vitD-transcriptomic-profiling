...
- **deprecated/provenance** = retained historical records for auditability, not active operational workflows.
...
| `notebooks/02_EDA.ipynb` | manuscript-associated | Explores annotation structure, expression patterns, recurrence, and candidate response summaries in the vitamin D signature set. | canonical | Exploratory figures for manuscript/supplementary use plus dashboard summary exports under `data/dashboard/`. | [02 EDA documentation](notebooks/02_EDA_documentation.md) |
