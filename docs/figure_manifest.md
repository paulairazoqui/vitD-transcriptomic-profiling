...
- Manuscript-associated figures are stored under `results/figures/paper/`, grouped by final manuscript figure directory (`figure_1`, `figure_2`, `figure_3`, `figure_5`, and `figure_6`) plus `supplementary/`.
...
|---|---|---|---|---|
| Figure 1A | `results/figures/paper/figure_1/figure_1A_pca.png`<br>`results/figures/paper/figure_1/figure_1A_pca.pdf` | `notebooks/03_EDA_subset.ipynb` | Main figure | Renamed from the pre-alignment `figure_2A_pca.*` outputs without regenerating figure content. |
...
- **Missing or unrepresented panels:** Figure 1 has detected outputs for panels 1A and 1C, but no detected Figure 1B output file.
